...
public class GpsStreamKafka {

    public static void main(String[] args) {

        // out put topic
        String simpleTrackerOutput = "SimpleTracker";  
        List<String> simpleTrackerInput = Arrays.asList("Tracker0", "Tracker1", "Tracker2", "Tracker3", "Tracker4", "Tracker5",
                "Tracker6", "Tracker7", "Tracker8", "Tracker9");
        Properties pro = new Properties();
        pro.put(StreamsConfig.APPLICATION_ID_CONFIG,"logProcessor");
        pro.put(StreamsConfig.BOOTSTRAP_SERVERS_CONFIG,"192.168.244.128:9092");

        // Serdes for converting an object into a stream of bytes and vice versa
        ...
        KStream<String, String> upperCasedStream = simpleFirstStream.filter(
                ...
                .filter((k, line)->Double.parseDouble(line.split(",")[1])>=115.5 && Double.parseDouble(line.split(",")[1])<=117.0);
